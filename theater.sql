...
(2, '國賓影城手機app海報', '2.jpg', 3, 0),
(3, '國賓影城防疫九宮格', '3.jpg', 4, 0),
(5, 'test1', '1.jpg', 6, 0),
(6, 'test2', '2.jpg', 5, 0),
...
(1, 4, 2, 'a:2:{i:0;s:9:\"喜劇片\";i:1;s:9:\"卡通片\";}'),
(2, 4, 9, 'a:1:{i:0;s:9:\"科幻片\";}'),
(3, 4, 13, 'a:2:{i:0;s:9:\"喜劇片\";i:1;s:9:\"卡通片\";}'),
(4, 4, 18, 'a:2:{i:0;s:9:\"愛情片\";i:1;s:9:\"驚悚片\";}'),
(5, 4, 3, 'a:2:{i:0;s:9:\"喜劇片\";i:1;s:9:\"卡通片\";}');
...
(4, 'qoooo', 'qqqq', 'q寶', '1111@', '0911', 2, 0, 1),
...
(3, '湯姆貓與傑利鼠', 'Tom and Jerry', '101', '普遍級', 'a:2:{i:0;s:9:\"喜劇片\";i:1;s:9:\"卡通片\";}', '2021-02-23', '克蘿伊摩蕾茲(Chloe Grace Moretz)、麥可潘納(Michael Peña)、鄭肯(Ken Jeong)、喬丹博爾傑(Jordan Bolger)', 'TomandJerry.jpg', 'tomandjerryB.jpg', 'NULL', '湯姆貓與傑利鼠轉戰大城市，來到紐約展開新生活，並在一間豪華飯店遇上「超殺女」克蘿伊摩蕾茲扮演的飯店新員工。她即將協助舉辦世紀婚禮，而且必須在婚禮前驅逐傑利鼠，於是找到湯姆貓來幫助她，但是計畫當然不是這麼簡單，湯姆貓與傑利鼠這對冤家在飯店裡追追跑跑，展開新的爆笑追逐。', 1, 2, 0),
...
(8, '杏林醫院', 'Hospital', '90', '輔導級', 'a:2:{i:0;s:9:\"驚悚片\";i:1;s:9:\"恐怖片\";}', '2021-02-23', '林柏宏、太保(Tai-Bo)、朱芷瑩、徐立期', 'Hospital.jpg', 'HospitalB.jpg', 'NULL', '由台南最負盛名的法師帶隊，曉玲與妙如，她們各懷目的，義無反顧踏入醫院，曾經在這發生的過往，逐漸湧上眼前。不料，醫院陰氣太重，壓的眾人喘不過氣；無法投胎的怨魂糾纏，生死危在旦夕…', 1, 16, 0),
(9, '女巫們', 'The Witches', '104', '普遍級', 'a:1:{i:0;s:9:\"科幻片\";}', '2021-02-23', '安海瑟威(Anne Hathaway)、奧塔薇亞史班森(Octavia Spencer)、史丹利圖奇(Stanley Tucci)、克里斯洛克(Chris Rock)', 'TheWitches.jpg', 'TheWitchesB.jpg', 'NULL', '這部作品以黑色幽默又暖人心房的手法，述說在1967年年底，有一個孤苦伶仃的男童（賈瑟布魯諾 飾）來到阿拉巴馬州鄉下的迪莫波利斯鎮，去跟他親愛的奶奶（奧塔薇亞史班森 飾）一起住。男孩與奶奶遇到一群神祕、迷人卻又殘忍的女巫，機靈的奶奶很快帶著孫子逃到一處熱鬧的海濱名勝。好巧不巧，就在他們抵達時，世上最厲害的「高階女巫」（安海瑟葳 飾）召集了她在全世界的同伴來到這裡，她們都做了偽裝，要一同展開高階女巫的邪惡計劃。', 0, 5, 0),
(12, '我沒有談的那場戀愛', 'I Missed You', '99', '普遍級', 'a:2:{i:0;s:9:\"愛情片\";i:1;s:9:\"喜劇片\";}', '2021-02-25', '吳慷仁、艾怡良、傅孟柏、9m88', 'imissedyou.jpg', 'imissedyouB.jpg', '', '劇情從「臉書的封鎖名單」展開，探討封鎖一個人，是因為一時任性？還是徹底不願再得知對方的任何消息？封鎖之後，就真的可以忘記嗎？\r\n \r\n男主角吳慷仁顛覆了以往偏愛的嚴肅角色，改以「花形壯美男」的形象詮釋一名桃花滿天的廣告才子，總是嘻皮笑臉的遊戲人間，一出口就是讓人分不清是實話還是玩笑話的人生金句。而在他跌落谷底之際，雖有眾多女友卻無處可歸，只好吃定了臉臭心善的女主角艾怡良，硬是賴在她的人生裡。', 1, 3, 0),
